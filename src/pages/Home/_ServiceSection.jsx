                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 py-5">
                        ...
                        <div className="card bg-base-100 border-b-4 border-b-red-500 border shadow-xl py-5">
                            <div className="card-body">
                                <div className="text-center">
                                    <div className="text-red-500 text-4xl"><i class="ph ph-user"></i></div>
                    ...
                    <div>
                        <div className="card bg-base-100 border-b-4  border-b-red-500 border shadow-xl py-5">
                            <div className="card-body">
                                <div className="text-center">
                                    <div className="text-red-500 text-4xl"><i class="ph ph-presentation-chart"></i></div>
                    ...
                    <div>
                        <div className="card bg-base-100 border-b-4  border-b-red-500 border shadow-xl py-5">
                            <div className="card-body">
                                <div className="text-center">
                                    <div className="text-red-500 text-4xl"><i class="ph ph-headset"></i></div>
